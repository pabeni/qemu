...
#define VIRTIO_FEATURES_PR(f)      f[0], f[1]

#define VIRTIO_FEATURES_MAX        128
#define VIRTIO_BIT(b)              (1ULL << (b & 0x3f))
#define VIRTIO_DWORD(b)            ((b) >> 6)
#define VIRTIO_FEATURES_DWORDS     (VIRTIO_FEATURES_MAX >> 6)
#define VIRTIO_FEATURES_WORDS      (VIRTIO_FEATURES_DWORDS >> 1)
...
{
    memset(features, 0, sizeof(features[0]) * VIRTIO_FEATURES_WORDS);
}
